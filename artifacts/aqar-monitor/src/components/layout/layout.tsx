      ...
      <div className="flex h-screen w-full bg-background overflow-hidden selection:bg-primary/20 flex-col">
        ...
        <div className="flex flex-1 min-h-0 w-full">
          ...
          <div className="flex flex-col flex-1 min-w-0">
            <header className="h-16 flex items-center justify-between px-8 bg-white/80 backdrop-blur-md z-10 border-b border-border shadow-sm shrink-0">
            ...
            <main className="flex-1 overflow-y-auto bg-background flex flex-col">
              ...
              {/* Footer */}
              <footer className="border-t border-border bg-muted/30 px-4 py-5 md:px-8 lg:px-12 mt-auto">
