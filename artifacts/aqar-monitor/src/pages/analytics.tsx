...
const BAR_COLORS = ["#0F7BA0", "#0F1C3F", "#C9A84C", "#34D399", "#8B5CF6", "#F97316", "#EF4444", "#64748B"];
            ...
            {!hasData && !loadingInsights ? (
              ...
              <>
                ...
                <div className="grid grid-cols-2 lg:grid-cols-4 gap-3">
                  ...
                  <KpiBlock label="الوسيط السعري" color="#C9A84C" loading={loadingInsights}
                  ...
                  <div className="p-5">
                      ...
                      {loadingTrends ? (
                        ...
                        <ResponsiveContainer width="100%" height="100%">
                          <LineChart data={trends} margin={{ top: 5, right: 16, bottom: 5, left: 0 }}>
                            ...
                            />
                            <Line yAxisId="l" type="monotone" dataKey="count" stroke="#C9A84C" strokeWidth={2.5} dot={{ r: 3, fill: "#C9A84C", strokeWidth: 0 }} name="count" />
                    ...
                    <div className="flex items-center justify-center gap-6 mt-2">
                      <div className="flex items-center gap-2 text-[12px] text-muted-foreground">
                        <span className="w-5 h-0.5 bg-[#C9A84C] rounded-full inline-block" /> عدد الإعلانات
                      </div>
                      <div className="flex items-center gap-2 text-[12px] text-muted-foreground">
