          ...
          <div className="relative z-10 p-8 md:p-12">
            <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-8">
              ...
              <div className="flex flex-col gap-4 shrink-0">
                {isAuthenticated ? (
                  <Button asChild size="lg" className="gap-2 rounded-2xl h-14 px-8 text-base font-bold bg-[#C9A84C] hover:bg-[#b8973e] text-white border-none shadow-xl shadow-[#C9A84C]/20">
